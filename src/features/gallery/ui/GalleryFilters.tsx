    ...
    <div className="w-full flex justify-between mb-6">
      <div className="flex gap-2 items-center">
        ...
        <Select
          ...
          showSearch={{
            filterOption: false,
            onSearch: setPricesFilterSearchValue,
          }}
          notFoundContent={
            pricesFilterLoading ? <Spin size="small" /> : "Услуги не найдены"
          }
        ...
        <Select
          ...
          showSearch={{
            filterOption: false,
            onSearch: setHorsesFilterSearchValue,
          }}
          notFoundContent={
            horsesFilterLoading ? <Spin size="small" /> : "Лошади не найдены"
          }
