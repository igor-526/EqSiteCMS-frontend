...
export const pricePageScopesRegistry: Record<
  PRICE_PAGE_SCOPES_ACTIONS,
  KNOWN_USER_SCOPES[]
> = {
  [PRICE_PAGE_SCOPES_ACTIONS.SEE_USER_INSTRUCTIONS]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.SEE_DEVELOPER_INSTRUCTIONS]: [
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_GROUP_RETRIEVE]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  ...
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_RETRIEVE]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_CREATE]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  ...
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_UPDATE]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_UPDATE_TABLES]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_UPDATE_PHOTOS]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_UPDATE_PAGE_DATA]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
  [PRICE_PAGE_SCOPES_ACTIONS.PRICE_DELETE]: [
    KNOWN_USER_SCOPES.ADMIN,
    KNOWN_USER_SCOPES.DEVELOPER,
  ],
...
export const usePricePageActionScopes = () => {
  ...
  const hasPermission = useCallback(
    (action: PRICE_PAGE_SCOPES_ACTIONS) => {
      return pricePageScopesRegistry[action].some((scope) =>
