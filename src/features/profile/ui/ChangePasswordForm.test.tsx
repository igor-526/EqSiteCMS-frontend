...
function renderPasswordForm(overrides?: Partial<{
    ...
    return { ...renderWithCmsProviders(<ChangePasswordForm {...props} />), props };
}
...
describe("ChangePasswordForm", () => {
    ...
    it("shows strength label when passwordStrength > 0", () => {
        renderPasswordForm({ passwordStrength: 2, strengthLabel: "Средний", strengthColor: "orange" });
