...
type ChangePasswordFormProps = Pick<
    ...
    "formState" | "passwordStrength" | "strengthLabel" | "strengthColor" | "saving" | "setField" | "changePassword" | "clear"
>;
...
export function ChangePasswordForm({
    ...
    return (
        <Card title={<div style={{ fontWeight: 600, fontSize: 16 }}>Смена пароля</div>}>
            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 16 }}>
                            ...
                            {Array.from({ length: STRENGTH_BARS }).map((_, index) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        height: 4,
                                        borderRadius: 2,
                                        background: index < passwordStrength ? strengthColor || "#d9d9d9" : "#d9d9d9",
                ...
                <div style={{ flex: "1 1 200px", minWidth: 180 }}>
                    <div style={{ marginBottom: 4, fontWeight: 500 }}>Повторите новый пароль</div>
                    <Input.Password
