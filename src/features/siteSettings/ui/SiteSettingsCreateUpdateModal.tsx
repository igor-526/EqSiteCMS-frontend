...
export const SiteSettingsCreateUpdateModal: React.FC<
...
> = ({
    ...
    if (open) {
      ...
      if (selectedSiteSetting) {
        ...
        const parsedValue = parseValueFromString(
          ...
          selectedSiteSetting.type,
        );
        if (
          selectedSiteSetting.type === SiteSettingType.number ||
          selectedSiteSetting.type === SiteSettingType.float
        ) {
  ...
  return (
    <Modal
      ...
      title={
        selectedSiteSetting
          ? "Изменить настройку сайта"
          : "Добавить настройку сайта"
      }
      onCancel={onClose}
      footer={footer}
    >
      ...
      <div className="mb-6 flex flex-col gap-2">
        ...
        <Select
          ...
          options={[
            ...
            {
              value: SiteSettingType.datetime,
