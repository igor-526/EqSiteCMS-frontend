...
const horseBaseSchema = z.object({
  ...
  slug: z
    .string()
    .max(63, "Путь URL должен быть не длиннее 63 символов")
    .optional()
    .nullable(),
  pedigree_name: z
    .string()
  ...
  breed_id: z
    .string()
    .uuid("Некорректный идентификатор породы")
    .optional()
    .nullable(),
  coat_color_id: z
    .string()
    .uuid("Некорректный идентификатор масти")
    .optional()
    .nullable(),
  height: z
    .number()
  ...
  horse_owner_id: z
    .string()
    .uuid("Некорректный идентификатор владельца")
    .optional()
    .nullable(),
