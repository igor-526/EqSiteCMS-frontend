...
export const HorseCoatColorsCreateUpdateModal: React.FC<
  HorseCoatColorsCreateUpdateModalProps
> = ({
  open,
  onClose,
  ...
  if (selectedHorseCoatColor) {
    ...
    if (canMutate) {
      footer.push(
        <Button
          ...
          onClick={() =>
            submit(() =>
              onUpdate(selectedHorseCoatColor.id, {
                name,
    ...
    footer.push(
      <Button
        ...
        onClick={() =>
          submit(() =>
            onCreate({ name, short_name: shortName, description, slug }),
          )
        }
      >
        <PlusOutlined />
  ...
  return (
    ...
    >
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseCoatColorNameInput">
          Наименование масти
        </label>
        <Input
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseCoatColorShortNameInput">
        ...
        {validationErrors.short_name ? (
          <div className="text-sm text-red-500">
            {validationErrors.short_name.join("\n")}
          </div>
        ) : (
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseCoatColorDescriptionInput">
          Описание масти
        </label>
        <TextArea
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseCoatColorSlugInput">
