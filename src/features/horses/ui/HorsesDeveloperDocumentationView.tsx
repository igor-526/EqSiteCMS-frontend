...
export const HorsesDeveloperDocumentationView: React.FC<
  HorsesDeveloperDocumentationViewProps
                ...
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-2">
                        Требует авторизованной CMS-сессии. Без токена вернёт
                        HTTP 401.
                      </td>
                    </tr>
                  </tbody>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                    ...
                    <tbody>
                      {[
                        [
                          "name",
                          "string",
                          "Фильтр по кличке (вхождение, регистронезависимо)",
                        ],
                        [
                          "description",
                          "string",
                          "Фильтр по описанию (вхождение)",
                        ],
                        [
                          "breed_ids",
                          "UUID[]",
                          "Фильтр по идентификаторам пород (множественный)",
                        ],
                        [
                          "coat_color_ids",
                          "UUID[]",
                          "Фильтр по идентификаторам мастей (множественный)",
                        ],
                        [
                          "kind",
                          "string[]",
                          "Фильтр по типу породы: horse | pony (множественный)",
                        ],
                        [
                          "sex",
                          "string[]",
                          "Пол: male | female | geld (множественный)",
                        ],
                        ...
                        [
                          "bdate_gte",
                          "date",
                          "Дата рождения — от (YYYY-MM-DD)",
                        ],
                        [
                          "bdate_lte",
                          "date",
                          "Дата рождения — до (YYYY-MM-DD)",
                        ],
                        ...
                        [
                          "horse_owner_ids",
                          "UUID[]",
                          "Фильтр по идентификаторам владельцев (множественный)",
                        ],
                        ["this_stable", "bool", "true — только лошади конюшни"],
                        [
                          "pedigree",
                          "int",
                          "Количество поколений родословной для включения в ответ",
                        ],
                        [
                          "exclude_ids",
                          "UUID[]",
                          "UUID лошадей, исключаемых из выдачи",
                        ],
                        [
                          "include_ids",
                          "UUID[]",
                          "UUID — искать только среди указанных",
                        ],
                ...
                <div className="mt-3 bg-blue-50 p-3 rounded border-l-4 border-blue-400">
                  <p className="text-blue-800 text-sm">
                    ...
                    <code>short_name</code> соответствующей сущности. По
                    умолчанию — <code>-updated_at, -created_at</code>.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <p className="text-sm mb-2">
                  Параметр пути: slug или UUID лошади. Опциональный
                  query-параметр <code>pedigree</code> (int) — глубина
                  родословной.
                </p>
              </div>
...
// GET /breeds/{id}?page_data=true — добавляется поле "page_data": "<html>"`}
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                <p className="text-yellow-800 text-sm">
                  ...
                  <code>name</code>, если не передан при создании. При
                  обновлении передавайте явно, если нужно изменить.{" "}
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
                  ...
                  <li>
                    <code>type</code> — фильтр по типу: <code>person</code> |{" "}
                    <code>company</code> (множественный)
                  </li>
                  <li>
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
                  ...
                  <li>
                    <code>sort</code>: <code>name</code>,{" "}
                    <code>description</code>, <code>slug</code>,{" "}
                    <code>price</code> (с <code>-</code> — по убыванию)
                  </li>
                  <li>
                    <code>limit</code>, <code>offset</code>
                  </li>
...
// ?page_data=true — добавляется "page_data": "<html>"`}
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                <p className="text-yellow-800 text-sm">
                  <strong>Цена в копейках:</strong> <code>price</code> хранится
                  и передаётся в копейках. Для отображения в рублях делите на
                  100. Для ввода 2 500 ₽ передавайте <code>250000</code>.
                </p>
              </div>
  ...
  -d '{"name": "Ковка", "price": 250000, "price_formatter": "equal"}'`}
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-400">
            ...
            <div className="space-y-3 text-yellow-800 text-sm">
              <p>
                <strong>Управление услугами</strong> доступно только
                разработчикам (<code>DEVELOPER</code>, <code>SUPERUSER</code>).
                Администраторы (<code>ADMIN</code>) могут обновлять описание,
                URL и цену услуги, но не могут создавать, удалять услуги или
                изменять их наименование.
              </p>
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-yellow-200">
                    <th className="border border-yellow-300 p-1 text-left">
                      Операция
                    </th>
                    <th className="border border-yellow-300 p-1 text-left">
                      SUPERUSER
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-yellow-300 p-1 text-green-600">
                      ✅
                    </td>
                    <td className="border border-yellow-300 p-1 text-green-600">
                      ✅
                    </td>
                    <td className="border border-yellow-300 p-1 text-red-600">
                      ❌
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="border border-yellow-300 p-1">
              ...
              <p>
                <strong>Примечание:</strong> При обновлении услуги, если
                наименование не изменилось (передано то же значение), запрос не
                будет отклонён, даже если пользователь — администратор.
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
            ...
            <div className="space-y-3 text-blue-800 text-sm">
              <p>
                Для site consumer доступна фильтрация лошадей по наименованиям
                услуг через query-параметр <code>service_names</code> на
                эндпоинте
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>
                  ...
                  <code>?service_names=разведение</code> найдёт лошадей с
                  услугой «разведение», но не «разведение и содержание».
                </li>
                <li>
                  <strong>Множественная фильтрация:</strong>{" "}
                  <code>
                    ?service_names=разведение&service_names=тренировка
                  </code>{" "}
                  — лошади с любой из указанных услуг.
                </li>
                <li>
                  <strong>Комбинирование:</strong> параметр можно сочетать с
                  другими фильтрами (<code>breed</code>, <code>coat_color</code>{" "}
                  и т.д.).
                </li>
              </ul>
...
curl -s "http://localhost:8001/api/horses?service_names=Ковка&breed=Орловский_рысак" \
  -H "X-Equestrian-Service-Key: <ключ>"`}
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Связь «лошадь-услуга» привязывает услугу из справочника к
                конкретной лошади с возможностью переопределить описание и цену.
                Одну и ту же услугу можно привязать к разным лошадям с разными
                параметрами.
              </p>
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <ul className="space-y-1 text-sm font-mono">
                  ...
                  <li className="bg-gray-800 text-green-400 p-2 rounded">
                    GET /api/horses/{"{horse_id}"}/services — список связей
                    лошади
                  </li>
                  <li className="bg-gray-800 text-green-400 p-2 rounded">
                    GET /api/horses/{"{horse_id}"}/available-services?search= —
                    доступные для привязки услуги
                  </li>
                </ul>
              </div>
...
// Передача null сбрасывает override — будет использоваться значение из справочника.`}
  ...
  "price_formatter": "equal"                 // override или из справочника
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <p className="text-sm mb-2">
                  Protected Write (требует авторизацию). Возвращает список
                  услуг, которые ещё не привязаны к данной лошади. Используется
                  для поиска в Select-поле при добавлении связи.
                </p>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
                  <li>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                <p className="text-yellow-800 text-sm">
                  ...
                  <code>price_formatter</code> возвращают override-значения,
                  если заданы, иначе — значения из справочника услуг.
                </p>
              </div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <p className="text-blue-800">
                  ...
                  отсутствии API вернёт <code>HTTP 400</code>. При
                  несуществующем ключе — <code>HTTP 404</code>.
                </p>
              </div>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <p className="text-blue-800">
                  Все списочные endpoint-ы поддерживают <code>limit</code> /{" "}
                  <code>offset</code>. Ответ всегда содержит{" "}
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4 text-blue-800 text-sm">
                  <li>
                    Отец: пол обязательно <code>male</code>
                  </li>
                  <li>
                    Мать: пол обязательно <code>female</code>
                  </li>
