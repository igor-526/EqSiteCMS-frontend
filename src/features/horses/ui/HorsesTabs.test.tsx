...
describe("HorsesTabs", () => {
    ...
    it("hides Инструкция tab for users without SEE_USER_DOCS scope", () => {
        ...
        expect(screen.queryByRole("tab", { name: "Инструкция" })).not.toBeInTheDocument();
    });
    ...
    it("hides Документация tab for ADMIN-only users (developer-docs requires DEVELOPER or SUPERUSER)", () => {
        ...
        expect(screen.queryByRole("tab", { name: "Документация" })).not.toBeInTheDocument();
    });
    ...
    it("shows Документация tab for DEVELOPER users", () => {
        ...
        expect(screen.getByRole("tab", { name: "Документация" })).toBeInTheDocument();
    });
});
