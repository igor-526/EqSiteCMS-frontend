...
const renderModal = (
    ...
    overrides: Partial<React.ComponentProps<typeof HorseServiceRelationCreateUpdateModal>> = {},
...
describe("HorseServiceRelationCreateUpdateModal", () => {
    ...
    it("renders available services select in create mode", () => {
        ...
        expect(screen.getByText("Начните вводить название услуги")).toBeInTheDocument();
    });
