...
export const HorseServicesCreateUpdateModal: React.FC<
  HorseServicesCreateUpdateModalProps
> = ({
  open,
  onClose,
  ...
  const [priceFormatter, setPriceFormatter] = useState<PriceFormatter>(
    PriceFormatter.equal,
  );
    ...
    if (canMutate) {
      footer.push(
        <Button
          ...
          type="primary"
          onClick={() =>
            onUpdate(selectedHorseService.id, {
              name: name,
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseServiceDescriptionInput">
          Описание услуги
        </label>
        <Input
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseServiceSlugInput">
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseServicePriceInput">
          Цена услуги по умолчанию
        </label>
        <Radio.Group
          block
          ...
          onChange={(e) => {
            onResetValidation();
            setPriceFormatter(e.target.value as PriceFormatter);
          }}
          optionType="button"
          disabled={!canMutate}
        />
          ...
          <>
            ...
            {validationErrors.hasOwnProperty("price") ? (
              ...
              <div className="text-sm text-gray-500">
                При привязке услуги к лошади цену можно будет переопределить для
                каждой лошади
              </div>
            )}
          </>
