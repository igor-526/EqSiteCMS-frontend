...
const renderModal = (selectedHorseService: HorseServiceOutDto | null, overrides = {}) =>
...
describe("HorseServicesCreateUpdateModal", () => {
    ...
    describe("Form submission", () => {
        it("submits create form data", async () => {
            ...
            await userEvent.type(screen.getByLabelText("Наименование услуги"), "Новая услуга");
        ...
        it("submits update form data", async () => {
            ...
            await userEvent.type(screen.getByLabelText("Наименование услуги"), "Обновленная услуга");
    ...
    describe("Field disabling for ADMIN", () => {
        ...
        it("enables slug field for ADMIN", () => {
            renderModal(service, { canMutate: true, canUpdateName: false });
            const slugInput = screen.getByLabelText("Путь в URL (генерируется автоматически)");
