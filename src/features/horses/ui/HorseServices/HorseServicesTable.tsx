...
export const HorseServicesTable: React.FC<HorseServicesTableProps> = ({
  ...
  const columns = [
        ...
        <>
          <div style={{ padding: 8 }}>
            <StringFilter
              ...
              onChange={(value) =>
                setFilters({ ...filters, description: value ?? undefined })
              }
    ...
    },
    {
      title: "Цена",
      key: "price",
      render: (record: HorseServiceOutDto) => (
    ...
    },
    {
      ...
      filterIcon: (
        <SearchOutlined
          style={{ color: filters.slug ? "#1677ff" : undefined }}
        />
      ),
      filterDropdown: (
        <>
          <div style={{ padding: 8 }}>
            <StringFilter
              value={filters.slug ?? ""}
              onChange={(value) =>
                setFilters({ ...filters, slug: value ?? undefined })
              }
