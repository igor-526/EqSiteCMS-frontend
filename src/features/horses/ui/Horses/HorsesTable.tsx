...
function buildPedigreeTooltip(
  pedigree: HorsePedigreeDto | null,
): React.ReactNode {
      ...
      filterDropdown: (
        <div style={{ padding: 8, minWidth: 250 }}>
          <ListFilter
            ...
            filterData={coatColorOptions.map((o) => ({
              key: o.value,
              label: o.label,
              value: o.value,
            }))}
    ...
    <>
      {error && (
        <Alert
          type="error"
          showIcon
          message="Не удалось загрузить лошадей"
          description={error}
        />
      )}
      <MainTable
