...
import { HORSE_PEDIGREE_MODE, PEDIGREE_PICKER_ACTION } from "../../constants/pedigree";
...
const getSubtitle = (intent: PedigreePickerIntent | null) => {
    if (!intent) return "";
    const prefix = intent.action === PEDIGREE_PICKER_ACTION.ADD ? "Добавить" : "Заменить";
    ...
    return (
        ...
        >
            <div className={styles.root}>
                ...
                {displayError && (
                    <Alert type="error" showIcon title={displayError} />
                )}

                <div data-testid="horse-pedigree-picker-results" className={styles.resultsPanel}>
