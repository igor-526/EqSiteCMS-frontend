...
export const HorsePedigreeCandidateButton: React.FC<HorsePedigreeCandidateButtonProps> = ({
    candidate,
    selected,
    onSelect,
}) => {
    ...
    return (
        <button
            type="button"
            onClick={handleClick}
            className={cx(styles.button, selected ? styles.buttonSelected : styles.buttonDefault)}
        >
            <span
