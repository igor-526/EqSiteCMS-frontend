    ...
    return (
        ...
        >
            <div className="flex flex-col gap-4">
                {/* Основные данные */}
                <div>
                    <Text style={{ display: "block", fontSize: 14, fontWeight: 600, color: "rgba(0,0,0,0.55)", marginBottom: 8, marginTop: 0 }}>
                        Основные данные
                    </Text>
                            ...
                            <Row gutter={8}>
                                <Col flex={1}>
                                    <DatePicker
                                        ...
                                        onChange={(d) => setBdate(d ? d.format("YYYY-MM-DD") : null)}
                            ...
                            <Row gutter={8}>
                                <Col flex={1}>
                                    <DatePicker
                                        ...
                                        onChange={(d) => setDdate(d ? d.format("YYYY-MM-DD") : null)}
