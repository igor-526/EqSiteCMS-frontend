...
export const HorseBreedCreateUpdateModal: React.FC<
  HorseBreedCreateUpdateModalProps
> = ({
  open,
  onClose,
  selectedHorseBreed,
    ...
    if (canMutate) {
      footer.push(
        <Button
          ...
          onClick={() =>
            submit(() =>
              onUpdate(selectedHorseBreed.id, {
                name,
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseBreedShortNameInput">
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseBreedDescriptionInput">
          Описание породы
        </label>
        <TextArea
      ...
      <div className="mb-6 flex flex-col gap-2">
        <label htmlFor="createHorseBreedSlugInput">
