...
export const NewsAdminDocumentationView: React.FC<
  NewsAdminDocumentationViewProps
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                В разделе <strong>&quot;Новости&quot;</strong> вы можете
                создавать, редактировать и удалять новости конюшни. Все новости
                отображаются в таблице с информацией о названии, сниппете, дате
                публикации и статусе.
              </p>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-blue-800">
                  ...
                  <li>
                    Заполните поля формы: название, сниппет (необязательно),
                    дату публикации
                  </li>
                  <li>
                  ...
                  <li>
                    После создания откройте новость, чтобы добавить
                    HTML-содержимое и фотографии
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-blue-800">
                  <li>
                    Кликните на строку новости в таблице, чтобы открыть форму
                    редактирования
                  </li>
              ...
              <div className="bg-red-50 p-5 rounded-lg border-l-4 border-red-400">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-red-800">
                  <li>
                    Откройте форму редактирования новости (кликните на строку в
                    таблице)
                  </li>
                  <li>
                ...
                <p className="text-red-800 mt-3">
                  <strong>Важно:</strong> Удаление является мягким (soft delete)
                  — запись физически не удаляется из базы данных, а помечается
                  как удалённая. Удалённые новости не отображаются на сайте, но
                  видны в CMS (статус &quot;Удалено&quot;).
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                автоматически на основе полей{" "}
                <code className="bg-gray-100 px-1 rounded">is_deleted</code> и{" "}
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-green-800">
                  Условие: новость не удалена (<code>is_deleted = false</code>)
                  И дата публикации в прошлом или настоящем (
            ...
            <div className="space-y-4 text-gray-700">
              <div className="bg-gray-50 p-5 rounded-lg">
                <ul className="space-y-3">
                  <li>
                    <strong>Название (name)</strong> — обязательное поле,
                    максимум 63 символа. Отображается как заголовок новости на
                    сайте.
                  </li>
                  <li>
                    <strong>Сниппет (snippet)</strong> — необязательное поле,
                    максимум 255 символов. Краткое описание, отображается в
                    списке новостей.{" "}
                    <em>
                      Если не заполнено — автоматически генерируется из
                      содержимого (HTML теги удаляются, берутся первые 255
                      символов текста).
                    </em>
                  </li>
                  <li>
                    <strong>Дата публикации (published_at)</strong> —
                    обязательное поле. Определяет, когда новость станет видимой
                    на сайте. Можно установить дату в будущем, чтобы
                    запланировать публикацию.
                  </li>
                  <li>
                    <strong>Содержимое (content)</strong> — HTML-контент
                    новости. Редактируется через встроенный HTML-редактор.
                    Заполняется после создания новости через кнопку
                    &quot;Редактировать HTML&quot;.
                  </li>
                  <li>
                    <strong>Фотографии (photos)</strong> — фотографии из
                    галереи, прикреплённые к новости. Одна из фотографий может
                    быть назначена главной.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-blue-800">
                  ...
                  <li>
                    Нажмите кнопку{" "}
                    <strong>&quot;Редактировать HTML&quot;</strong>
                  </li>
              ...
              <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-400">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 text-yellow-800">
                  ...
                  <li>
                    <strong>Inline-обработчики событий запрещены:</strong>{" "}
                    Нельзя использовать атрибуты вида <code>onclick=</code>,{" "}
                    <code>onerror=</code> и т.д.
                  </li>
                  <li>
                    Разрешён только безопасный HTML: параграфы, заголовки,
                    таблицы, ссылки, изображения, форматирование текста
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-blue-800">
                  <li>
                    ...
                    <strong>&quot;Управление фото&quot;</strong> в форме
                    редактирования
                  </li>
                  <li>В открывшемся окне выберите фотографии из галереи</li>
                  <li>
                    Для назначения главной фотографии нажмите на иконку звезды
                    рядом с фотографией
                  </li>
                  <li>
                ...
                <p className="text-blue-800 mt-3">
                  <strong>Главная фотография</strong> отображается как обложка
                  новости в списке и в детальном просмотре на сайте.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                В таблице новостей доступны несколько инструментов фильтрации
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    <strong>По наименованию</strong> — текстовый поиск по
                    названию новости (регистронезависимый)
                  </li>
                  <li>
