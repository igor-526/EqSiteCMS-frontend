...
export const NewsDeveloperDocumentationView: React.FC<
  NewsDeveloperDocumentationViewProps
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <p className="text-gray-600 mb-8">
            ...
            использующих публичный API для получения новостей. Все публичные
            методы требуют наличия заголовка аутентификации сервиса.
          </p>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Публичный API новостей использует аутентификацию по ключу
                сервиса. Для каждого запроса необходимо передавать заголовок:
              </p>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                <p className="text-yellow-800">
                  <strong>Без ключа:</strong> Запрос вернёт HTTP 400 (Bad
                  Request). Ключ сервиса предоставляется администратором CMS.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    ...
                    (integer, опционально, по умолчанию 1) — номер страницы
                  </li>
                  <li>
                    <code className="bg-gray-200 px-1 rounded">limit</code>{" "}
                    (integer, опционально, по умолчанию 25) — количество записей
                    на странице
                  </li>
                </ul>
              </div>
  ...
  "photos": [...]
              ...
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                <p className="text-red-800">
                  <strong>HTTP 404:</strong> Возвращается если новость не
                  найдена, удалена (<code>is_deleted = true</code>) или ещё не
                  опубликована (<code>published_at &gt; сейчас</code>).
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="bg-gray-50 p-5 rounded-lg">
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    ...
                    (string) — название новости (максимум 63 символа)
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    (array) — массив фотографий (см. раздел 5)
                  </li>
                </ul>
              </div>
              <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                <p className="text-red-800">
                  <strong>Явно отсутствуют поля:</strong> <code>content</code>,{" "}
                  <code>is_deleted</code>, <code>deleted_at</code> — эти поля
                  доступны только в CMS-endpoint&apos;е и не передаются
                  потребителям.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                ...
                <code className="bg-gray-100 px-1 rounded">photos</code>{" "}
                содержит:
              </p>
              <div className="bg-gray-50 p-5 rounded-lg">
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    ...
                    (string) — полный URL для отображения фотографии
                  </li>
                  <li>
              ...
              <p className="text-gray-500 text-sm">
                Главная фотография (<code>is_main: true</code>) всегда идёт
                первой в массиве.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4 text-gray-700">
              <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-400">
                ...
                <p className="text-yellow-800">
                  ...
                  является защищённым и предназначен исключительно для
                  CMS-администраторов. Он возвращает все новости включая
                  удалённые и неопубликованные. Использовать его в
                  сайте-потребителе запрещено — он вернёт HTTP 401.
                </p>
              </div>
              ...
              <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-400">
                ...
                <p className="text-blue-800">
                  ...
                  <code>published_at &le; сейчас</code>. Сортировка
                  фиксированная — по дате публикации (новые первыми).
                  Дополнительная фильтрация на клиенте не требуется.
                </p>
              </div>
            </div>
          </section>
